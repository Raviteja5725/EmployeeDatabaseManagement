...
public class Estuate {
	
	public static void main(String[] args) {
		System.out.println("Welcome to Estuate...");
		...
		while (true) {
			...
			if (select == 1) {
				...
				case 2:
					...
					Employee emp1 = session.get(Employee.class, id1 );
				...
				case 4:
					...
					//Creating Session Factory
					SessionFactory sessionFactory4 = configuration.buildSessionFactory();

					//Initialize Session Object
					Session session4 = sessionFactory.openSession();
					System.out.println("Enter Employee Id whose Data want to DELETE...");
					int id4 = scan.nextInt();
					Employee emp4 = session.get(Employee.class, id4);
					session.delete(emp4);
					session.beginTransaction();
					session.getTransaction().commit();
					break;
